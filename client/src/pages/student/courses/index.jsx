...
function StudentViewCoursesPage() {
  ...
  async function handleCourseNavigate(getCurrentCourse) {
    const response = await addCourseToMyCoursesService(getCurrentCourse, auth?.user?._id,auth?.user?.userName,auth?.user?.userEmail);
    if (response?.success) {
      console.log(getCurrentCourse?._id+"myid");
